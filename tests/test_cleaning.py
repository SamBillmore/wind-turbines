...
def test_clean_raw_data(spark: SparkSession) -> None:
    ...
    input_data = [
        ("2023-01-01 00:00:00", 1, 10.0),
        ("2023-01-01 01:00:00", 1, 12.0),
        ("2023-01-01 02:00:00", 2, -5.0),  # Invalid power output
        ("2023-01-01 03:00:00", 2, None),  # Missing value
        ("2023-01-01 04:00:00", 1, 15.0),
    ]
    ...
    expected_schema = "timestamp TIMESTAMP, turbine_id INT, power_output DOUBLE"
